        ...
        <div class="card-body">
            ...
            <form id="eventForm" class="space-y-4" method="post" action="{{ route('admin.events.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="judul" placeholder="Contoh: Konser Musik Rock" class="input input-bordered w-full" required />
                </div>
                ...
                <div class="form-control">
                    ...
                    <br>
                    <textarea name="deskripsi" placeholder="Deskripsi lengkap tentang event..." class="textarea textarea-bordered h-24 w-full" required></textarea>
                </div>
